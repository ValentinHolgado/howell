...
class testApp : public ofBaseApp, public PdReceiver{
	...
	public:
		...
		void cargarProyecto(string projectFolder);
		...
		ofRectangle HDurDisplay;
		ofRectangle MDurDisplay;
		ofRectangle SDurDisplay;

        void setupTimeline(string folderPath);

		void setCurPageHValue(string& value);
		void setCurPageMValue(string& value);
		void setCurPageSValue(string& value);
		void timelinePageChanged( ofxTLPageEventArgs& argsx );
		void nextPage(ofxTLPlaybackEventArgs& args);
        ...
        vector< vector<pista> > pageTracksList;
